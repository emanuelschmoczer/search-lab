...
Navigate to the **Collections** tab of your database deployment, pick the `books` collection, and avigate to the **Aggregation** tab from the navbar under your collection details.
